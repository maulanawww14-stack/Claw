...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] text-center">
      ...
      <h1 className="relative mb-6 text-6xl font-black tracking-tight text-white md:text-8xl">
        Build <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-emerald-400">Better</span>.
      </h1>
      <p className="max-w-xl mb-12 text-xl font-medium text-slate-400">
        Template project modern dengan React, TypeScript, Tailwind, dan Zustand yang sudah terintegrasi dengan Routing.
      </p>
