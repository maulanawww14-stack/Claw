...
const ProfilePage: React.FC = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto pt-10 px-6">
      <h1 className="text-4xl font-black text-slate-900 dark:text-white mb-10 uppercase tracking-tight">User Profile</h1>
      ...
      <div className="p-10 border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-800/40 rounded-3xl backdrop-blur-xl shadow-2xl relative overflow-hidden">
        ...
        <div className="flex items-center gap-6 mb-10 pb-10 border-b border-slate-200 dark:border-slate-800/50">
          ...
          <div>
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white leading-tight">{username || 'Guest Identity'}</h2>
            <p className="text-sm font-bold text-blue-600 dark:text-blue-500 uppercase tracking-widest">Developer Access</p>
          </div>
        </div>
